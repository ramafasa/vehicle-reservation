package com.rmaciak.vehicle.reservation.infrastructure.serialization;
...
import com.rmaciak.vehicle.reservation.infrastructure.events.EventTypeMapper;
...
public final class EventSerializer {
    ...
    public static <Event> Optional<Event> deserialize(Class<Event> eventClass, ResolvedEvent resolvedEvent) {
        try {
            return Optional.ofNullable(mapper.readValue(resolvedEvent.getEvent().getEventData(), eventClass));
        } catch (IOException e) {
